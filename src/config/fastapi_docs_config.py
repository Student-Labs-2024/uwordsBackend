...
Нужен админ-доступ. Метод, начисляющий подписку пользователю вручную\
"""
...
UPLOAD_BOT_AUDIO_TITLE = """\
Загрузить аудио из бота\
"""

UPLOAD_BOT_AUDIO_DESCRIPTION = """\
Нужна авторизация (SERVICE токен). Метод для загрузки аудио из бота \
для его дальнейшей обработки, перевода слов и формированию личного \
словаря пользователя\
"""
...
BOT_PROMO_DESCRIPTION = """\
Нужна авторизация (SERVICE токен). Метод для ввода промокода через бота\
"""
