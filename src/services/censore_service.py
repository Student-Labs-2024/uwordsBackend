...
class CensoreFilter:
    ...
    regular_expression = re.compile(PATTERN_1, re.U | re.I)

    word_pattern = r'[А-яA-z0-9\-]+'

    @staticmethod
    def is_censore(text: str):
        return bool(CensoreFilter.regular_expression.findall(text))

    @staticmethod
    def replace(text: str, repl: str = '[censored]'):
        return CensoreFilter.regular_expression.sub(repl, text)
